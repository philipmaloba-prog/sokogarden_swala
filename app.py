...
# we need to configure our upload folder
...
def add_product():
    ...
    # extracy the file name
    filename=product_photo.filename
    # specify the comp path where image will be saved(static/images)
...
@app.route('/api/mpesa_payments',methods=['POST'])
def mpesa_payments():
